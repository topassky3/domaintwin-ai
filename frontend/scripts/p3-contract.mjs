...
const checks = [
  ...
  [aiViews.includes("tenant_scoped_queryset") && aiViews.indexOf("get_object_or_404(rows, id=incident_id)") < aiViews.indexOf("generate_incident_explanation"), "AI incident lookup is tenant-scoped before evidence generation/provider execution"],
