        ...
        catalog.append(
            {
                ...
                "fact": (
                    ...
                    else f"DNS resolution failed: {dns_resolution.get('error') or 'unknown error'}."
                ),
                "data": dns_resolution,
            }
        )
...
def generate_incident_explanation(
    ...
    *,
    ...
    explanation, created = IncidentExplanation.objects.update_or_create(
        incident=incident,
        evidence_fingerprint=incident.evidence_fingerprint,
        provider=provider_name,
        model=model,
    ...
    return explanation, False if existing else created
